...
1. 업그레이드 누적에 따른 캐릭터 외형 진화 (`FX-003`)
2. 대장 몬스터 포함 실제 40분·400회 성장·평균 50회 사망 완주 표본 수집
3. `PERF-003` 재개 전 실제 기기 GPU·발열 프로파일링
4. 나머지 5개 캐릭터 고유 특수 능력 구현
5. 익명 완주 랭킹 API 도입 전 보안·운영 설계 검토
