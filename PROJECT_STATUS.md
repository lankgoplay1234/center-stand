...
- 모바일 에뮬레이션 하위 10% FPS가 26.84로 30 FPS 목표에 미달하며 `PERF-003` 최적화가 필요하다.
...
1. 모바일 100적 전투 30 FPS 하위 구간 최적화 (`PERF-003`)
2. 실제 Android/iOS 기기 발열·배터리 수동 검수
3. 다음 캐릭터 고유 특수 능력 수직 구현
4. 텔레그램 작업 결과 보고 구현 (`OPS-001`)
5. 적 변형 및 보스 데이터 설계 (`GAME-004`)
